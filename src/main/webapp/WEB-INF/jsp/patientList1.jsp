                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${useri}" var="foruser">
           							<tr>
           								<td><c:out value="${foruser.firstName}"/></td>
           							 	<td><c:out value="${foruser.lastName}"/></td>
           							 	<td> <c:out value="${foruser.email}"/></td>
           							 	<td><a href="<c:url value='/patientList/recipe-${foruser.email}-patient' />" class="btn btn-success custom-width">ADD RECIPE</a></td> 		
            						</tr>
       								 </c:forEach>
                                </tbody>
                            </table>
